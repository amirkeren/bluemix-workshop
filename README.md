...
1. Deploy the CloudFoundry web application using the "Deploy to Bluemix" button below (you'll need to sign in to Jazz Hub and on first login you'll be prompted to choose an alias for your account)
